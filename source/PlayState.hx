...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['qwertyuiop be like', 0.2], //From 0% to 19%
		['Unfunny', 0.4], //From 20% to 39%
		['Bad', 0.5], //From 40% to 49%
		['Not Ok', 0.6], //From 50% to 59%
		['Ok', 0.69], //From 60% to 68%
		['funny gooba number', 0.7], //69%
		['Cool', 0.8], //From 70% to 79%
		['Kool', 0.9], //From 80% to 89%
		['Pog!', 1], //From 90% to 99%
		['Poggers!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
