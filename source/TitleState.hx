...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('vboii'));
		add(ngSpr);
		ngSpr.visible = false;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 6:
					...
					#else
					createCoolText(['Remastered Version Of'], -40);
					#end
				case 8:
					addMoreText('VS Boii And Woofy', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Boii And Woofy'); // credTextShit.text += '\nFunkin';
