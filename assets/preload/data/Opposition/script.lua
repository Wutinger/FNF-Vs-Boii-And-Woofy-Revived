...
function onCreatePost()
   makeLuaText("message", "S0n% b) M@ev(ng$ hjkhjklhjklhjklhjkhjkhjkhljkhjklhuiotgtyu;ojik'o'ipo;kp[[]]][]tpytoyitoy[rptgkrleoeiruu%%^G7868H2YDHJ982E792PUJE892EFYB73R532HERy783hj9r3wf7r84jf5q8957905H789 8mn79035y5fh783hj0yNM*u(H83794jy m9*P*&(#Y809", 500, 30, 50)
   setTextAlignment("message", "left")
   addLuaText("message")

   makeLuaText("engineText", "O(*osit0n - (n0t) V$ B0() v-^%5 (B%$@} ;' Psydf ng&^e -.2", 500, 30, 30)
